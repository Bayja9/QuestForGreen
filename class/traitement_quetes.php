...
if (isset($_POST['enregistrerq']))
{
    ...
    $unquetes = new quetes(NULL, $nom_que, $desc_que, $date_fin_que, $dif_que, $period_que, $amont_que,'','','','');
...
if (isset($_POST['modifierq']))
{
    ...
    $unquetes = new quetes ($id_que, $nom_que, $desc_que, $date_fin_que, $dif_que, $period_que, $amont_que, $etat_que,"","","");
